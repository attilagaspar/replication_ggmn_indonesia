...
estadd local csignal "Number of scandals"
...
estadd local csignal "Worse audit pre-election"
estadd local districtfe	"No"
estadd local ethdummies	"Yes"
estadd local villagecontrols	"Yes"
eststo
...
reghdfe d_islamist c  minority_var c_minor  `controls'   , cluster(`clustervar') noabsorb
estadd local outcome "Diff. vote share"
estadd local csignal "Raw audit score"
estadd local districtfe	"No"
estadd local ethdummies	"Yes"
estadd local villagecontrols	"Yes"
eststo
...
esttab using "${results_dir}/main_table_different_signal.tex"  ///
	...
	compress  nonotes ///
	tex ///
		mgroups("1999-2004" "2014-2019", pattern(1  0 1 0 0 0 )) ///
	nomtitles ///
	obslast ///
	se(3)  ///
	b(3) ///
