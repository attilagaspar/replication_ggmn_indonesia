...
/* EEZ ELÉG SZÜRKEZÓNA - KEVÉS A DUPLIKÁTOM DE NEM TUDOM, HOGY NEM SCRAPING
ERROR OKOZZA-E */
duplicates tag i pc, gen(t)
drop if t==1&votes==0
duplicates drop i pc, force

* ezekről SEMMIT nem tudunkj, de akadályozza a reshape-et
...
*"../${processed_data_dir}/podes_with_ethnicity_treatment_b18.dta", clear
...
preserve
	*use ../data/consistent/election2014_reshaped_village.dta, clear
